...
public interface CitiesRepository extends JpaRepository<Cities, Integer>, _CitiesRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<CitiesDto> request, HashMap<String, java.lang.Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(CitiesDto dto, HashMap<String, java.lang.Object> param, Integer index,  Locale locale) throws Exception{
