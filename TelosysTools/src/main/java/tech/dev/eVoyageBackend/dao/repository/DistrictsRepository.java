...
public interface DistrictsRepository extends JpaRepository<Districts, Integer>, _DistrictsRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<DistrictsDto> request, HashMap<String, java.lang.Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(DistrictsDto dto, HashMap<String, java.lang.Object> param, Integer index,  Locale locale) throws Exception{
