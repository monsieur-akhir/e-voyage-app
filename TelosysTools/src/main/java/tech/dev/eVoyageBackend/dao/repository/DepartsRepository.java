...
public interface DepartsRepository extends JpaRepository<Departs, Integer>, _DepartsRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<DepartsDto> request, HashMap<String, java.lang.Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(DepartsDto dto, HashMap<String, java.lang.Object> param, Integer index,  Locale locale) throws Exception{
