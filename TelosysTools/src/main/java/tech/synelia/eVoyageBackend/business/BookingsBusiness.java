...
import tech.synelia.eVoyageBackend.dao.entity.Bookings;
import tech.synelia.eVoyageBackend.dao.entity.Users;
import tech.synelia.eVoyageBackend.dao.entity.Buses;
...
public class BookingsBusiness implements IBasicBusiness<Request<BookingsDto>, Response<BookingsDto>> {
	...
	public Response<BookingsDto> create(Request<BookingsDto> request, Locale locale)  throws ParseException {
		...
		for (BookingsDto dto : request.getDatas()) {
			...
			entityToSave = BookingsTransformer.INSTANCE.toEntity(dto, existingUsers, existingBuses, existingRoutes);
