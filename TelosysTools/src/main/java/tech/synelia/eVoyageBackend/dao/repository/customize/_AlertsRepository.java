...
/**
 * Repository customize : Alerts.
 */
@Repository
public interface _AlertsRepository {
	default List<String> _generateCriteria(AlertsDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
