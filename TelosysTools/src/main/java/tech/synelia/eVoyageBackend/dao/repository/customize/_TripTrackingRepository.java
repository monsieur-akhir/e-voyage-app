...
/**
 * Repository customize : TripTracking.
 */
@Repository
public interface _TripTrackingRepository {
	default List<String> _generateCriteria(TripTrackingDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
