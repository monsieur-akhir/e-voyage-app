...
public interface RoutesTransformer {
	...
	@Mappings({
		...
		@Mapping(source="entity.cities.name", target="citiesNameOrigin"),
	//	@Mapping(source="entity.cities.code", target="citiesCodeOrigin"),
		...
		@Mapping(source="entity.cities2.name", target="citiesNameDestination"),
	//	@Mapping(source="entity.cities2.code", target="citiesCodeDestination"),
	})
