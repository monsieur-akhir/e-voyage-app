...
public class RoutesDto extends _RoutesDto implements Cloneable{
    ...
    //----------------------------------------------------------------------
	private String citiesNameOrigin;
	private String citiesCodeOrigin;
	private String companiesName;
	private String citiesNameDestination;
	private String citiesCodeDestination;
	...
	private SearchParam<String>   citiesNameOriginParam       ;
	private SearchParam<String>   citiesCodeOriginParam       ;
	private SearchParam<String>   companiesNameParam    ;                     
	private SearchParam<String>   citiesNameDestinationParam;
	private SearchParam<String>   citiesCodeDestinationParam;
