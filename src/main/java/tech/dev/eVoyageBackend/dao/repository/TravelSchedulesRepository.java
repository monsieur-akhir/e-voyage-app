...
public interface TravelSchedulesRepository extends JpaRepository<TravelSchedules, Integer>, _TravelSchedulesRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<TravelSchedulesDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(TravelSchedulesDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{
