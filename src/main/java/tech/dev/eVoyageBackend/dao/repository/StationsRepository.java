...
public interface StationsRepository extends JpaRepository<Stations, Integer>, _StationsRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<StationsDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(StationsDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{
