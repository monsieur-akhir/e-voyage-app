...
public interface CompaniesRepository extends JpaRepository<Companies, Integer>, _CompaniesRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<CompaniesDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(CompaniesDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{
