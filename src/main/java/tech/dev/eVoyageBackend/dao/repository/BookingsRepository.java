...
public interface BookingsRepository extends JpaRepository<Bookings, Integer>, _BookingsRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<BookingsDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(BookingsDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{
		...
		if (dto != null) {
			...
			if (Utilities.notBlank(dto.getStationsArrivalName())) {
				listOfQuery.add(CriteriaUtils.generateCriteria("stationsName", dto.getStationsArrivalName(), "e.stations2.name", "String", dto.getStationsNameArrivalParam(), param, index, locale));
			}
			if (Utilities.notBlank(dto.getStationsDepartureName())) {
				listOfQuery.add(CriteriaUtils.generateCriteria("stationsName", dto.getStationsDepartureName(), "e.stations.name", "String", dto.getStationsNameDepartureParam(), param, index, locale));
			}
