...
import tech.dev.eVoyageBackend.dao.repository.customize._TicketsRepository;
...
public interface TicketsRepository extends JpaRepository<Tickets, Integer>, _TicketsRepository {
	...
	/**
	 * Finds Tickets by using companyId as a search criteria.
	 * 
	 * @param companyId
	 * @return An Object Tickets whose companyId is equals to the given companyId. If
	 *         no Tickets is found, this method returns null.
	 */
	@Query("select e from Tickets e where e.companies.id = :companyId and e.isDeleted = :isDeleted")
	List<Tickets> findByCompanyId(@Param("companyId")Integer companyId, @Param("isDeleted")Boolean isDeleted);
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<TicketsDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(TicketsDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{
